...
#     workbook = openpyxl.load_workbook(file)
#     sheet = workbook[sheetname]
#     greenfill = PatternFill(start_color='00FF00', end_color='00FF00',patternType = 'solid') #hexavalue of green colour
...
#     workbook = openpyxl.load_workbook(file)
#     sheet = workbook[sheetname]
#     redfill = PatternFill(start_color='FF0000', end_color='FF0000',patternType = 'solid') #hexavalue of green colour
